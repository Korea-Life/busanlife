...
class Tinymce_Advanced {
	...
	private $default_settings = array(
		...
		'toolbar_4' => '',
		// edit by KH
		'plugins'   => 'anchor,code,insertdatetime,nonbreaking,print,preview,searchreplace,table,visualblocks,visualchars,emoticons,advlist',
	);
	...
	function get_plugins( $plugins = array() ) {
		...
		// added by KH
		if ( in_array( 'preview', $this->used_buttons, true ) )
			$plugins[] = 'preview';
