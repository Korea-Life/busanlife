...
<# 
	var labels = { 
		...
		gradient: '<?php _e('BG Gradient', 'kingcomposer'); ?>' 
	};
...
#>
	...
	<div class="kc-param-row field-toggle">
		<div class="m-p-r-label">
			<label><?php _e('Use Image?', 'kingcomposer'); ?> :</label>
		</div>
		<div class="m-p-r-content">			
			<div class="kc-toggle-field-wrp">
				<div class="switch">
			...
			<div class="m-p-r-des"><?php _e('Use image or gradient for background', 'kingcomposer'); ?></div>
		</div>
	</div>
	...
	<div class="kc-control-field children box-bg kc-hidden">
		...
		<div class="kc-param-row field-color_picker">
			...
			<div class="m-p-r-content">
				<input name="linearGradient" value="" data-css-background="gradient" placeholder="<?php _e('Select top color', 'kingcomposer'); ?>" type="search" autocomplete="off" style="width: 48%;" />
				<input name="linearGradient-bottom" value="" data-css-background="gradient" placeholder="<?php _e('Select bottom color', 'kingcomposer'); ?>" type="search" autocomplete="off" style="width: 48%;" />
				<br />
