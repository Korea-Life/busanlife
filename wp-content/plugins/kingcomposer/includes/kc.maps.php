				...
				'general' => array(
					...
					array(
						...
						'options' => array(
							array(
								'group' => array(
									array('property' => 'gap', 'label' => 'Columns Gap', 'des' => __('The distance between the columns in this row', 'kingcomposer'), 'selector' => '>.kc_column_inner'),
								)
							)
						)
					),
			...
			'params'		   => array(
				'general' => array(
					...
					array(
						...
						'options'	=> array(
							array(
								'Map Height CSS' => array(
									array('property' => 'height', 'label' => 'Map Height', 'value' => '350px', 'selector' => '.kc-google-maps'),
								)
							)
						)
					),
