	...
	<div class="page" id="activate-page">
		...
		<?php if ( bp_account_was_activated() ) : ?>
			...
			<?php else : ?>
				...
				printf( __( 'Your account was activated successfully! You can now <a href="%s">log in</a> with the username and password you provided when you signed up.', 'buddypress' ), $login_page ); 
