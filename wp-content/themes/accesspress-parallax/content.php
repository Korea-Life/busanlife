...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	?>
			...
			<a id="btn-delete" style="color:#333333; border: 2px solid #333333" class="btn" href="#" value=<?php the_ID(); ?>><?php _e('Delete'    ,'accesspress-parallax'); ?></a>   
			</div>
	...
	<?php 
		...
		// edit by KH
		//edit_post_link( __( '<i class="fa fa-pencil-square-o"></i>Edit', 'accesspress-parallax' ), '<span class="edit-link">', '</span>' ); 
	?>
</article><!-- #post-## -->
