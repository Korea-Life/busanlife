...
/*
	//echo "<script type='text/javascript' src='//cdn.tinymce.com/4/tinymce.min.js'></script>\n";
	
	echo "<script type='text/javascript'>\n";
	echo "tinymce.init({\n";
	echo "	selector: '#tinymce',  // change this value according to your HTML\n";
	echo "	plugins: 'preview',\n";
	echo "	menubar: 'view',\n";
	echo "	toolbar: 'preview'\n";
	echo "});\n";
	echo "</script>\n";
*/
}
