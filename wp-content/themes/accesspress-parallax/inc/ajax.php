...
<select class="of-section of-section-layout" name="accesspress_parallax[parallax_section][<?php echo $countsettings; ?>][layout]">
	...
	<!-- added by KH -->
	<option value="forum-testimonial_template"><?php _e('Forum-Testimonial Section', 'accesspress-parallax') ?></option>
	<option value="group-portfolio_template"><?php _e('Group-Portfolio Section', 'accesspress-parallax') ?></option>
</select>
</div>
